...
class RecommendationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommendation" do
    assert_difference("Recommendation.count") do
      post recommendations_url, params: { recommendation: { course_id: @recommendation.course_id, instructor_email: @recommendation.instructor_email, section_id: @recommendation.section_id, student_email: @recommendation.student_email, testimonial: @recommendation.testimonial } }
    end
  ...
  test "should update recommendation" do
    patch recommendation_url(@recommendation), params: { recommendation: { course_id: @recommendation.course_id, instructor_email: @recommendation.instructor_email, section_id: @recommendation.section_id, student_email: @recommendation.student_email, testimonial: @recommendation.testimonial } }
